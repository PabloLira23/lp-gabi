  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-mist text-slate">
      <div className="mx-auto max-w-[1440px] px-4 py-4 sm:px-6 lg:px-8">
        <header className="sticky top-4 z-40 rounded-[30px] border border-white/65 bg-white/80 px-5 py-4 shadow-[0_24px_60px_rgba(241,87,51,0.08)] backdrop-blur-xl md:px-8">
        ...
        <main className="pb-20 pt-6 md:pb-28">
          <section
            id="inicio"
            className="relative overflow-hidden rounded-[42px] border border-white/50 bg-white/70 px-6 py-8 shadow-[0_35px_120px_rgba(241,87,51,0.10)] md:px-10 md:py-10 lg:px-14 lg:py-14"
          >
            ...
            <div className="relative grid gap-10 lg:grid-cols-[1fr_0.95fr] lg:items-center">
              <div className="max-w-3xl">
                ...
                <div className="mt-10 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                  {metrics.map((item) => (
                    <div
                      key={item.label}
                      className="rounded-[22px] border border-forest/8 bg-white/82 px-4 py-4 shadow-[0_10px_30px_rgba(241,87,51,0.06)] backdrop-blur"
                    >
              ...
              <div className="relative min-h-[700px]">
                <div className="absolute left-4 right-18 top-0 bottom-18 overflow-hidden rounded-[38px] bg-white p-3 shadow-[0_30px_90px_rgba(241,87,51,0.16)]">
                  <img
                    src={heroPortrait}
                ...
                <div className="absolute bottom-0 left-0 w-[56%] rounded-[30px] bg-white/92 p-5 shadow-[0_20px_50px_rgba(241,87,51,0.10)] backdrop-blur">
          ...
          >
            <div className="rounded-[38px] border border-white/60 bg-white/82 p-8 shadow-[0_28px_80px_rgba(241,87,51,0.07)] backdrop-blur md:p-10">
              <p className="text-[11px] font-extrabold uppercase tracking-[0.32em] text-forest/65">
                Sobre mim
              </p>
            ...
            <div className="grid gap-6 lg:grid-cols-[1.08fr_0.92fr]">
              <div className="overflow-hidden rounded-[38px] bg-white p-3 shadow-[0_28px_80px_rgba(241,87,51,0.10)] lg:row-span-2">
                <img
              ...
              <div className="overflow-hidden rounded-[38px] bg-white p-3 shadow-[0_28px_70px_rgba(241,87,51,0.08)]">
                <img
          ...
          <section
            id="contato"
            className="grid gap-6 rounded-[42px] border border-white/60 bg-white/82 px-6 py-10 shadow-[0_28px_80px_rgba(241,87,51,0.07)] backdrop-blur md:px-10 md:py-12 lg:grid-cols-[0.9fr_1.1fr]"
          >
            <div>
              <p className="text-[11px] font-extrabold uppercase tracking-[0.32em] text-forest/65">
                Formas de contato
              ...
              <div className="mt-8 space-y-4">
                {contactLinks.map((contact) => (
                  <div
                    key={contact.label}
                    className="rounded-[24px] border border-forest/10 bg-white/88 px-5 py-5 shadow-[0_12px_30px_rgba(241,87,51,0.05)]"
                  >
                    <p className="text-[11px] font-extrabold uppercase tracking-[0.24em] text-forest/62">
                      {contact.label}
                    </p>
